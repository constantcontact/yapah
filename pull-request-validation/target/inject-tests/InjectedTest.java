...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/Users/rdavis/repos/pull-request-validation-plugin/pull-request-validation");
    parameters.put("artifactId","pull-request-validation");
    parameters.put("outputDirectory","/Users/rdavis/repos/pull-request-validation-plugin/pull-request-validation/target/classes");
    parameters.put("testOutputDirectory","/Users/rdavis/repos/pull-request-validation-plugin/pull-request-validation/target/test-classes");
